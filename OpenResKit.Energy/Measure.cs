...
namespace OpenResKit.Energy
{
    public class Measure
    {
        ...
        public virtual double SavedMoneyShould { get; set; }            // kalkulierter Geldbetrag der nach gelungener Maßnahme eingespart wird (theoretischer Soll-Wert -> Potenzial)
        public virtual double SavedMoneyIs { get; set; }                // Geldbetrag der nach gelungener Maßnahme eingespart ist (tatsächliche Einsparung nach beendeter Maßnahme)
        ...
        public virtual double SavedWattShould { get; set; }             // kalkulierter Energieverbrauch der nach gelungener Maßnahme eingespart wird (theoretischer Soll-Wert -> Potenzial)
        public virtual double SavedWattIs { get; set; }                 // Energieeinsparung der nach gelungener Maßnahme eingespart ist (tatsächliche Einsparung nach beendeter Maßnahme)
        public virtual double SavedCo2 { get; set; }                    // CO2 Einsparung durch gelungene Maßnahme

        public virtual double PaybackTime { get; set; }                    // Zeit (GeplanteKosten / GeldEinsparung) bis Maßnahme sich rentiert hat (Amortisationszeit in Tagen)
